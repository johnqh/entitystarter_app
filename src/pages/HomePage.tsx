    ...
    <>
      ...
      <Section spacing="5xl" variant="hero" maxWidth="3xl">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-foreground mb-6">{t('home.title')}</h1>
          <p className="text-lg text-muted-foreground mb-8">{t('home.description')}</p>
      ...
      <Section spacing="3xl" maxWidth="4xl">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-lg border border-border">
            ...
            <p className="text-sm text-muted-foreground">{t('home.feature1Desc')}</p>
          </div>
          <div className="p-6 rounded-lg border border-border">
            <h3 className="text-lg font-semibold text-foreground mb-2">
              {t('home.feature2Title')}
            </h3>
            <p className="text-sm text-muted-foreground">{t('home.feature2Desc')}</p>
          </div>
          <div className="p-6 rounded-lg border border-border">
            <h3 className="text-lg font-semibold text-foreground mb-2">
              {t('home.feature3Title')}
            </h3>
            <p className="text-sm text-muted-foreground">{t('home.feature3Desc')}</p>
          </div>
        </div>
      </Section>
    </>
